...
data:
  loolwsd.xml: |
    <config>
        ...
        <allowed_languages desc="List of supported languages of Writing Aids (spell checker, grammar checker, thesaurus, hyphenation) on this instance. Allowing too many has negative effect on startup performance." default="de_DE en_GB en_US es_ES fr_FR it nl pt_BR pt_PT ru">en_US</allowed_languages>
        ...
        <server_name desc="Hostname:port of the server running loolwsd. If empty, it's derived from the request." type="string" default="">collabora.${DOMAIN}</server_name>
        ...
        <net desc="Network settings">
          ...
          <service_root type="path" default="" desc="Prefix all the pages, websockets, etc. with this path.">https://nextcloud.${DOMAIN}/collabora</service_root>
        ...
        <storage desc="Backend storage">
            ...
            <wopi desc="Allow/deny wopi storage. Mutually exclusive with webdav." allow="true">
                <host desc="Regex pattern of hostname to allow or deny." allow="true">nextcloud.${DOMAIN}</host>
            ...
            <webdav desc="Allow/deny webdav storage. Mutually exclusive with wopi." allow="false">
                <host desc="Hostname to allow" allow="false">nextcloud.${DOMAIN}</host>
            </webdav>
        </storage>
...
EOF
	;;
"off")
	kubectl delete -n app-${APPNAME} configmap conf
	;;
*)
